## What does The Guardian Scraper do?
...
2. Use the default start URLs or customize them to only scrape a section or category on The Guardian
3. Select the maximum number of items you want to scrape.
4. Click *Start*
5. Preview and export your data from the *Dataset* tab

## Why scrape The Guardian?
...
## How much will it cost to scrape The Guardian?
The Guardian Scraper is very cheap to run so you can extract a large amount of articles even on an Apify free plan. If you need to get more data, you should sign up for one of our [paid plans](https://apify.com/pricing). Every Apify plan includes free monthly usage credits that you can use with The Guardian Scraper.

## Is it legal to scrape The Guardian?
...
Please be aware that most articles on the internet are under copyright protection. If you intend to publish or reuse article content, check the terms of use of The Guardian.
