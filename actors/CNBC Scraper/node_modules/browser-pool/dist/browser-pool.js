...
const fingerprint_generator_1 = tslib_1.__importDefault(require("fingerprint-generator"));
...
class BrowserPool extends tiny_typed_emitter_1.TypedEmitter {
    constructor(options) {
        ...
        Object.defineProperty(this, "fingerprintsOptions", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        (0, ow_1.default)(options, ow_1.default.object.exactShape({
            ...
            fingerprintsOptions: ow_1.default.optional.object,
        }));
        const { browserPlugins, maxOpenPagesPerBrowser = 20, retireBrowserAfterPageCount = 100, operationTimeoutSecs = 15, closeInactiveBrowserAfterSecs = 300, preLaunchHooks = [], postLaunchHooks = [], prePageCreateHooks = [], postPageCreateHooks = [], prePageCloseHooks = [], postPageCloseHooks = [], useFingerprints = false, fingerprintsOptions = {}, } = options;
    ...
    async _createPageForBrowser(pageId, browserController, pageOptions = {}, proxyUrl) {
        ...
        (0, timeout_1.tryCancel)();
        this.emit("pageCreated" /* PAGE_CREATED */, page); // @TODO: CONSIDER renaming this event.
        return page;
    }
    /**
    ...
    retireBrowserController(browserController) {
        ...
        this.emit("browserRetired" /* BROWSER_RETIRED */, browserController);
    ...
    async _launchBrowser(pageId, options) {
        ...
        this.emit("browserLaunched" /* BROWSER_LAUNCHED */, browserController);
    ...
    _overridePageClose(page) {
        ...
        page.close = async (...args) => {
            ...
            this.emit("pageClosed" /* PAGE_CLOSED */, page);
        };
    }
    ...
    _initializeFingerprinting() {
        ...
        this.fingerprintGenerator = new fingerprint_generator_1.default(this.fingerprintsOptions.fingerprintGeneratorOptions);
